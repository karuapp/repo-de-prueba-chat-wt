...
const TicketsListCustom = (props) => {
  ...
  useEffect(() => {
    ...
    const filteredTickets = tickets.filter((t) => {
      ...
      if ((t.isGroup === true && t.assignedUsers && t.assignedUsers.split(',').indexOf(user.id.toString()) > -1) || queueIds.indexOf(t.queueId) > -1) {
  ...
  useEffect(() => {
    ...
    if (typeof updateUnreadMessagesTickets === 'function') {
      updateUnreadMessagesTickets(totalUnreadMessages);
    }
  }, [ticketsList, updateUnreadMessagesTickets]);
