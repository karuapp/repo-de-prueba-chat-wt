...
import WbotSelectCustom from "../WbotSelectCustom/index.js";
...
const UserModal = ({ open, onClose, userId }) => {
	...
	const handleSaveUser = async values => {
		const userData = { ...values, whatsappId, queueIds: selectedQueueIds, wbotIds: selectedWbotIds };

		if (whatsappId && !selectedWbotIds.includes(whatsappId)) {
			toast.error('Fila principal deve estar entre as conexões');
			return;
		}
