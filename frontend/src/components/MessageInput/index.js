...
import { AttachFile, CheckCircleOutline, Clear, Comment, Create, Description, HighlightOff, Mic, Mood, MoreVert, Send, PermMedia, Person, Reply, Timer, Close } from "@material-ui/icons";
        ...
        >
          ...
          <div className={classes.newMessageBox}>
            <Hidden only={["sm", "xs"]}>
              ...
              >
                {showEmoji ? (
                  <Close className={classes.sendMessageIcons} />
                ) : (
                  <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" className={classes.sendMessageIcons} version="1.1" x="0px" y="0px" enableBackground="new 0 0 24 24">
                    <title>Emoji</title>
